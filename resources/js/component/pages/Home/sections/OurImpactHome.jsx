...
export default function OurImpactHome({ imageSrc, href = "/OurImpact", label = "Our Impact" }) {
    const content = (
        <div
        ...
        >
            <img src={imageSrc} alt={label} className="absolute inset-0 h-full w-full object-contain" />
